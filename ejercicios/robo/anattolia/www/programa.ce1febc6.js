...
var cantidadImagen = tile.cantidadX * tile.cantidadY;
var imagenActual = 0;
var grilla = {
  x: 0,
  y: 0
};
document.querySelector('input').addEventListener('change', extractFrames, false); //const fuente = 'https://juancgonzalez.com/labmoviles/suenos/capa2/tren.mp4';
//document.fuente.addEventListener('change', extractFrames, false);

function extractFrames() {
  var video = document.createElement('video'); //video.src = 'https://juancgonzalez.com/labmoviles/suenos/capa2/tren.mp4';
  ...
  function onend(e) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      img.src = URL.createObjectURL(array[i]); //img.width = tile.width;
  ...
  video.src = URL.createObjectURL(this.files[0]); //video.src = 'https://juancgonzalez.com/labmoviles/suenos/capa2/tren.mp4';
